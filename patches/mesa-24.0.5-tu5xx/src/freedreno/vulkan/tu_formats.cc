...
/* tu5xx: a5xx 顶点格式表（fd5_format.c 的顶点部分子集）。
 * 探针只需要 float/int 常规格式；后续按需扩充。 */
struct tu_native_format
tu5_format_vtx(enum pipe_format format)
{
   enum a5xx_vtx_fmt fmt = VFMT5_NONE;
   enum a3xx_color_swap swap = WZYX;

   switch (format) {
   /* 8-bit */
   case PIPE_FORMAT_R8_UNORM:    fmt = VFMT5_8_UNORM; break;
   case PIPE_FORMAT_R8_SNORM:    fmt = VFMT5_8_SNORM; break;
   case PIPE_FORMAT_R8_UINT:     fmt = VFMT5_8_UINT; break;
   case PIPE_FORMAT_R8_SINT:     fmt = VFMT5_8_SINT; break;
   case PIPE_FORMAT_R8G8_UNORM:  fmt = VFMT5_8_8_UNORM; break;
   case PIPE_FORMAT_R8G8_SNORM:  fmt = VFMT5_8_8_SNORM; break;
   case PIPE_FORMAT_R8G8_UINT:   fmt = VFMT5_8_8_UINT; break;
   case PIPE_FORMAT_R8G8_SINT:   fmt = VFMT5_8_8_SINT; break;
   case PIPE_FORMAT_R8G8B8_UNORM: fmt = VFMT5_8_8_8_UNORM; break;
   case PIPE_FORMAT_R8G8B8_UINT:  fmt = VFMT5_8_8_8_UINT; break;
   case PIPE_FORMAT_R8G8B8A8_UNORM: fmt = VFMT5_8_8_8_8_UNORM; break;
   case PIPE_FORMAT_R8G8B8A8_SNORM: fmt = VFMT5_8_8_8_8_SNORM; break;
   case PIPE_FORMAT_R8G8B8A8_UINT:  fmt = VFMT5_8_8_8_8_UINT; break;
   case PIPE_FORMAT_R8G8B8A8_SINT:  fmt = VFMT5_8_8_8_8_SINT; break;
   case PIPE_FORMAT_B8G8R8A8_UNORM:
      fmt = VFMT5_8_8_8_8_UNORM;
      swap = WXYZ;
      break;
   /* 16-bit */
   case PIPE_FORMAT_R16_UNORM:   fmt = VFMT5_16_UNORM; break;
   case PIPE_FORMAT_R16_SNORM:   fmt = VFMT5_16_SNORM; break;
   case PIPE_FORMAT_R16_UINT:    fmt = VFMT5_16_UINT; break;
   case PIPE_FORMAT_R16_SINT:    fmt = VFMT5_16_SINT; break;
   case PIPE_FORMAT_R16_FLOAT:   fmt = VFMT5_16_FLOAT; break;
   case PIPE_FORMAT_R16G16_UNORM: fmt = VFMT5_16_16_UNORM; break;
   case PIPE_FORMAT_R16G16_SNORM: fmt = VFMT5_16_16_SNORM; break;
   case PIPE_FORMAT_R16G16_UINT:  fmt = VFMT5_16_16_UINT; break;
   case PIPE_FORMAT_R16G16_SINT:  fmt = VFMT5_16_16_SINT; break;
   case PIPE_FORMAT_R16G16_FLOAT: fmt = VFMT5_16_16_FLOAT; break;
   case PIPE_FORMAT_R16G16B16A16_UNORM: fmt = VFMT5_16_16_16_16_UNORM; break;
   case PIPE_FORMAT_R16G16B16A16_SNORM: fmt = VFMT5_16_16_16_16_SNORM; break;
   case PIPE_FORMAT_R16G16B16A16_UINT:  fmt = VFMT5_16_16_16_16_UINT; break;
   case PIPE_FORMAT_R16G16B16A16_SINT:  fmt = VFMT5_16_16_16_16_SINT; break;
   case PIPE_FORMAT_R16G16B16A16_FLOAT: fmt = VFMT5_16_16_16_16_FLOAT; break;
   /* 32-bit */
   case PIPE_FORMAT_R32_UINT:    fmt = VFMT5_32_UINT; break;
   case PIPE_FORMAT_R32_SINT:    fmt = VFMT5_32_SINT; break;
   case PIPE_FORMAT_R32_FLOAT:   fmt = VFMT5_32_FLOAT; break;
   case PIPE_FORMAT_R32G32_UINT: fmt = VFMT5_32_32_UINT; break;
   case PIPE_FORMAT_R32G32_SINT: fmt = VFMT5_32_32_SINT; break;
   case PIPE_FORMAT_R32G32_FLOAT: fmt = VFMT5_32_32_FLOAT; break;
   case PIPE_FORMAT_R32G32B32_UINT: fmt = VFMT5_32_32_32_UINT; break;
   case PIPE_FORMAT_R32G32B32_SINT: fmt = VFMT5_32_32_32_SINT; break;
   case PIPE_FORMAT_R32G32B32_FLOAT: fmt = VFMT5_32_32_32_FLOAT; break;
   case PIPE_FORMAT_R32G32B32A32_UINT: fmt = VFMT5_32_32_32_32_UINT; break;
   case PIPE_FORMAT_R32G32B32A32_SINT: fmt = VFMT5_32_32_32_32_SINT; break;
   case PIPE_FORMAT_R32G32B32A32_FLOAT: fmt = VFMT5_32_32_32_32_FLOAT; break;
   /* packed（VK A2B10G10R10 = Mesa B10G10R10A2） */
   case PIPE_FORMAT_B10G10R10A2_UNORM:
      fmt = VFMT5_10_10_10_2_UNORM;
      break;
   case PIPE_FORMAT_B10G10R10A2_UINT:
      fmt = VFMT5_10_10_10_2_UINT;
      break;
   default:
      unreachable("tu5xx: unsupported vertex format");
   }

   return (struct tu_native_format) {
      .fmt = (enum a6xx_format) fmt, /* 位宽与 a6xx_format 枚举不同，仅透传给 VFD_DECODE */
      .swap = swap,
   };
}
