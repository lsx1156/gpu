...
template <>
constexpr inline struct fd_gpu_event_info fd_gpu_events<A5XX>[FD_GPU_EVENT_MAX] = {
    {VS_DEALLOC, false},              /* FD_WRITE_PRIMITIVE_COUNTS (a6xx-only, placeholder) */
    {WT_DONE_TS, false},              /* FD_START_PRIMITIVE_CTRS (a6xx-only, placeholder) */
    {WT_DONE_TS, false},              /* FD_STOP_PRIMITIVE_CTRS (a6xx-only, placeholder) */
    ...
    {CACHE_FLUSH_TS, true},           /* FD_CACHE_INVALIDATE (a5xx 无对应事件, 用 UCHE 寄存器写替代, 暂占位) */
    {PC_CCU_INVALIDATE_DEPTH, false}, /* FD_CCU_INVALIDATE_DEPTH */
    {PC_CCU_INVALIDATE_COLOR, false}, /* FD_CCU_INVALIDATE_COLOR */
    {PC_CCU_RESOLVE_TS, false},       /* FD_CCU_FLUSH_BLIT_CACHE (a6xx-only, a5xx 无 BLIT resolve TS) */
    ...
    {BLIT, false},                    /* FD_BLIT */
    {WT_DONE_TS, false},              /* FD_LABEL (a6xx-only, placeholder) */
};
